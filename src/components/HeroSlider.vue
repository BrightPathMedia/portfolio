<template>
  <div
    class="slide h-full w-full flex flex-col lg:flex-row flex-grow-1 flex-shrink-0"
...
export default {
  ...
  methods: {
    animate() {
      ...
      setTimeout(
        () => (this.textAnimClass = "anim-in"),
        animDelay + animInterval
      );
      setTimeout(
        () => (this.textAnimClass = "anim-out"),
        animDelay + animInterval * 2
      );
      setTimeout(
        () => (this.textAnimClass = "anim-in-2"),
        animDelay + animInterval * 2 + this.textDisplayTime
      );
      setTimeout(
        () => (this.textAnimClass = "pre-anim"),
        animDelay + animInterval * 3 + this.textDisplayTime
      );
      setTimeout(
        () => (this.slideAnimClass = "img-only"),
        animDelay + animInterval * 4 + this.textDisplayTime
      );
    }
  }
};
