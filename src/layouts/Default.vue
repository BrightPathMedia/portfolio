    ...
    <div class="container flex flex-col min-h-screen max-h-screen">
      <header class='flex-none lg:px-2'>
        <nav class="flex items-center justify-between flex-wrap py-2">
          ...
          <div class="mobile-menu w-full block lg:flex lg:items-center lg:w-auto"
            ...
            <div class="text-sm text-right lg:flex-grow">
              ...
              <br class="lg:hidden"/>
              <g-link class="inline-block lg:px-2 lg:mx-1 pb-1 font-bold header-link" to="/about"> {{ $t("header.about") }} </g-link>
              <br class="lg:hidden"/>
              <g-link class="inline-block ml-3 pb-1 font-bold header-link" to="/contact"> {{ $t("header.contact") }}</g-link>
            </div>
          </div>
        </nav>
      </header>

      <div class='content flex flex-grow'>
        <slot/>
      </div>
...
<style lang='scss' scoped>
  ...
  @media (max-width: 1023px) {
    ...
    .header-link, .dropdown-link .header-link {
